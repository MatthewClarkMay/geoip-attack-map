...
syslog_path = '/var/log/snort.log'
db_path = '/home/user/geoip-attack-map_v4/DataServerDB/GeoLite2-City.mmdb'
...
def main():
    ...
    global continents_tracked, countries_tracked, ips_tracked, ips_tracked2, postal_codes_tracked, event_count, unknown, ip_to_code, country_to_code
    ...
    with io.open(syslog_path, "r", encoding='ISO-8859-1') as syslog_file:
        while True:
            ...
            if not line:
                ...
                #print('entrei!!')
                syslog_file.seek(0,0)
            else:
                syslog_data_dict = parse_syslog(line)
                syslog_file.seek(0,0)
                #sleep(0.2)
               
                if syslog_data_dict != data3:
                   data3=syslog_data_dict
                else:
                    syslog_data_dict=False  
                ...
                if syslog_data_dict:
                    ...
                    if ip_db_unclean:
                        ...
                        track_stats(super_dict, ips_tracked2, 'dst_ip')
                        ...
                        super_dict['ips_tracked2'] = ips_tracked2
                        ...
                        redis_instance.publish('attack-map-v4', json_data)
