...
class WebSocketChatHandler(tornado.websocket.WebSocketHandler):
    ...
    def listen(self):
        ...
        try:
            ...
            yield tornado.gen.Task(self.client.subscribe, 'attack-map-v4')
    ...
    def on_message(self, msg):
        ...
        if 'ip_blocked' in msg:
          ip = re.split(":",msg)
          fp = open('/mnt/map_attack_blk/blocked.log','a')
          fp.write(ip[1]+"\n")
          fp.close()
        ...
        if 'ips_tracked' in json_data:
            ...
            ips_tracked = None
        if 'ips_tracked2' in json_data:
            ips_tracked2 = json_data['ips_tracked2']
        else:
            ips_tracked2 = None
...
def main():
    ...
    handlers = [
                ...
                (r'/static/(.*)', tornado.web.StaticFileHandler, {'path': '/home/user/geoip-attack-map_v4/AttackMapServer/static'}),
                (r'/flags/(.*)', tornado.web.StaticFileHandler, {'path': '/home/user/geoip-attack-map_v4/AttackMapServer/static/flags'}),
                (r'/', IndexHandler)
                ]
